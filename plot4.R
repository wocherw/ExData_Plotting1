...
# Plot 3
# 
# Upper Left : x-axis : Global Active Power 234-246
# Upper Right : x-axis : Voltage 0-8
# Lower Left : x-axis : Energy sub metering (0-40)
# 				Legend
# Lower Right : x-axis : Global Reactive Power  0.0 - .05
#
# y-axis : Thu  Fri  Sat
#------------------------------------------------------------------------------------------------------------------------------------
...
# Upper Left : x-axis : Global Active Power 234-246
with(data.02, plot(date_time, Global_active_power, type="l", col="black", xlab="", ylab="Global Active Power"))

# Upper Right : x-axis : Voltage 0-8
with(data.02, plot(date_time, Voltage, type="l", col="black", xlab="datetime", ylab="Voltage"))
...
# Lower Right : x-axis : Global Reactive Power  0.0 - .05
with(data.02, plot(date_time, Global_reactive_power, type="l", col="black", xlab="datetime", ylab="Global_reactive_power"))
